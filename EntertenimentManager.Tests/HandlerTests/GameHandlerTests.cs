...
namespace EntertenimentManager.Tests.HandlerTests
{
    ...
    public class GameHandlerTests
    {
        ...
        private readonly GameHandler _gameHandler = new(new FakeGameRepository(), new FakePersonalListRepository(), new FakeStorage());
        private GenericCommandResult _result = new();
        private readonly CreateGameCommand _validCreateGameCommand;
        private readonly CreateGameCommand _notExistentPersonalListIdCreateGameCommand;
        ...
        {
            _validCreateGameCommand = new CreateGameCommand("GTA V", "Sandbox", "RockStar Games", 2013, _existentPersonalListId, _base64Image, new());
            _notExistentPersonalListIdCreateGameCommand = new CreateGameCommand("GTA V", "Sandbox", "RockStar Games", 2013, _notExistentPersonalListId, _base64Image, new());
            _aPersonalListNotAssociateWithUserIdCreateCommand = new CreateGameCommand("GTA V", "Sandbox", "RockStar Games", 2013, _existentPersonalListId, _base64Image, new()) { UserId = -1 };
            _invalidCreateGameCommand = new CreateGameCommand("", "", "", 2013, 1, _base64Image, new());
            _differentCategoryTypeCreateCommand = new CreateGameCommand("GTA V", "Sandbox", "RockStar Games", 2013, _personalListIdWithDifferentCategoryType, _base64Image, new());
        }
        ...
        {
            var res = await _gameHandler.Handle(_validCreateGameCommand);
        ...
        {
            var res = await _gameHandler.Handle(_invalidCreateGameCommand);
            _result = (GenericCommandResult)res;
        ...
        {
            var res = await _gameHandler.Handle(_notExistentPersonalListIdCreateGameCommand);
            _result = (GenericCommandResult)res;
            Assert.AreEqual(_result.Message, "Não foi possível adicionar o jogo à lista");
        }

        [TestMethod]
        public async Task ShouldReturnFailWhensPersonalListFromCreateIsNotAssociatedWithUserIdCommand()
        {
            var res = await _gameHandler.Handle(_aPersonalListNotAssociateWithUserIdCreateCommand);
            _result = (GenericCommandResult)res;
            Assert.AreEqual(_result.Message, "Não é possível criar o jogo na lista informada");
        }

        [TestMethod]
        public async Task ShouldReturnFailWhensPersonalListCategoryTypeItsNotEnumGameCommand()
        {
        ...
        {
            var res = await _gameHandler.Handle(_getANotExistentGameByIdCommand);
            _result = (GenericCommandResult)res;
            Assert.AreEqual(_result.Message, "Não foi possível obter o jogo");
        }

        [TestMethod]
        public async Task ShouldReturnSuccessWhenGetAExistentGameByIdCommand()
        {
            var res = await _gameHandler.Handle(_getGameByIdCommand);
            _result = (GenericCommandResult)res;
            Assert.IsTrue(_result.Success);
        }

        [TestMethod]
        public async Task ShouldReturnFailWhensGameIsNotAssociatedWithUserIdCommand()
        {
